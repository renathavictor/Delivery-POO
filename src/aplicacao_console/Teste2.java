...
public class Teste2 {
	...
	public static void parte1 () {		
		...
		try {
			//CLIENTES
			//-----------------------
			Cliente joao = Fachada.cadastrarCliente("98745-0643", "joao", "poo.projeto.delivery@gmail.com",
					"Rua dos Tronos, 3");
			System.out.println("cadastrou cliente="+joao.getNome());
			Cliente maria = Fachada.cadastrarCliente("98820-0222", "maria", "poo.projeto.delivery@gmail.com",
					"Rua da Justiça, 12");			
			...
			Fachada.enviarPedido("98745-0643", "ifpb2019");
			Fachada.enviarPedido("98820-0222", "ifpb2019");
...
//			System.out.println("consultar pedido ="+ Fachada.consultarPedido("98745-0643"));
	...
	public static void parte2 () {
		...
		Collection<Cliente> clientes = Fachada.listarClientes();
		if (!clientes.isEmpty())
